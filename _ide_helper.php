 ...
 * Generated for Laravel 5.1.17 (LTS) on 2015-10-31.
 *
...
namespace {
    ...
    class Clef extends \Lollypop\Services\ClefFacade{
         ...
         * @static 
         */
        public static function generateStateNonce(){
            return \Lollypop\Services\Clef::generateStateNonce();
        }
        
        /**
         * 
         *
         * @param $state Validate if $state variable is a valid one
         * @return bool 
         * @static 
         */
        public static function validate_state($state){
            return \Lollypop\Services\Clef::validate_state($state);
        }
         ...
         * @static 
         */
        public static function makeHandShake($request){
            return \Lollypop\Services\Clef::makeHandShake($request);
        }
         ...
         */
        public static function getUserInfo(){
            return \Lollypop\Services\Clef::getUserInfo();
        }
         ...
         * @static 
         */
        public static function logout($logout_token){
            return \Lollypop\Services\Clef::logout($logout_token);
        }
